...
class bot():
    ...
    def login(self):
        ...
        sleep(.5)
        self.driver.find_element(By.XPATH,"/html/body/div[2]/div/div/div[1]/div/div[3]/span/div[1]/div/button").click()
        self.handle = []
    ...
    def like(self):
        ...
        like = self.driver.find_element(By.XPATH,'//*[@id="content"]/div/div[1]/div/main/div[1]/div/div/div[1]/div/div[2]/div[4]/button')
        like.click()
        sleep(1)
    def dislike(self):
        ...
        dislike = self.driver.find_element(By.XPATH,'//*[@id="content"]/div/div[1]/div/main/div[1]/div/div/div[1]/div/div[2]/div[2]/button')
        dislike.click()
        sleep(1)
    ...
    def getimagelink(self):
        sleep(1)
        image = self.driver.find_element(By.XPATH,'/html/body/div[1]/div/div[1]/div/main/div[1]/div/div/div[1]/div/div[1]/div[3]/div[1]/div/div/div/div/div').get_attribute('style')
        link = image.split("\"")[1]
        return link
